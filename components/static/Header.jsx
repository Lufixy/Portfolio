        ...
        <nav className='p-4 '>
            <div className='flex justify-between items-center'>
                <div className='flex items-center space-x-4'>
                    ...
                    <button className='text-white bg-indigo dark:bg-indigo/75 w-10 p-1 rounded-md translation duration-300' onClick={() => setTheme(colorTheme)}>
                        {colorTheme === 'light' ? <i className="fa-solid fa-sun-bright"></i> : <i className='fas fa-moon'></i>}
                    </button>
                </div>
                <div className='space-x-7 hidden sm:flex'>
                   {
                    config.titles.map((title, index) => (
                        ...
                        <a  className={` text-md font-light translation duration-300 ${router.pathname  === title.url ? 'text-indigo' : 'text-black/75 hover:text-indigo dark:text-white/50 dark:hover:text-white'} `}  >
                            {title.title}
                    </a>
                    </Link>
                    ))
                ...
                <div className='flex items-center'>
                  ...
                  <button className='bg-indigo dark:bg-indigo/75 font-medium p-2 w-32 translation duration-300 hover:bg-indigo/60 rounded-md text-white'>
                    <a href='https://discord.com/users/714464777388294237' target="_blank" >Contact</a>
                  </button>
                 ...
                 
                 {
                        ...
                        open ? ( 
                            ...
                            <span className="px-2 py-1 cursor-pointer hover:bg-back/25 dark:text-white text-black dark:hover:bg-indigo/25  text-sm rounded-md font-light  flex flex-col items-center text-center">
                              <i className={"w-8 p-1 fa-regular " + title.icon} >
                              </i>
