...
>
            ...
            <div>
                <div className="flex justify-between items-center">
                    <div className="flex items-center">
                        <img src={data?.album_art_url} alt="" className="w-[85px] p-[8px] h-[85px] rounded-xl" />
                        <div className="ml-3">
  ...
  <label htmlFor="like">
    <svg xmlns="http://www.w3.org/2000/svg" className="svg" viewBox="0 0 189.2 87.507" style={{overflow: 'visible'}}>
